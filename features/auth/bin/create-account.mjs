...
// Define available roles using TypeScript-style enums even in JS
const USER_ROLES_ENUM = ["client", "admin", "public"] as const;
type UserRoleType = typeof USER_ROLES_ENUM[number];
