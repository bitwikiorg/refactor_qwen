...
UserSchema.methods.compareHashedPasswd = async function(candidatePass) {
   try {
...
UserSchema.statics.createNew = async function(username, password, options = {}) {
   const newUser = new this({ username, hashedPassword: password, ...options });
